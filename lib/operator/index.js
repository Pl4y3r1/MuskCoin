...
class Operator {
    ...
    //ToDo, Database name should be recorded and updated if this is ever called instead of defaulting to the .... default of 1
    static blockchainOnly(blockchain){
    	return new Operator(1, blockchain);
    }
    ...
    createTransaction(walletId, fromAddressId, toAddressId, amount, changeAddressId) {
        ...
        //Let's make sure that the toAddress exists in the blockchain
